...
<body>
	...
	<!-- Page top Section -->
	<section class="page-top-section set-bg" data-setbg="img/back.jpg">
		<div class="container">
			<div class="row">
				<div class="col-lg-7 m-auto text-white">
					<h2>Roar Fitness</h2>
					<p>A hub for workouts and wellness</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="pricing-section spad">
		<div class="container">
			<div class="section-title text-center">
				<img src="img/icons/weights.png" alt="">
				<h2>Categories of Plans</h2>
				<p>Hit the gym to build strength, boost confidence, and live life at your best!</p>
			</div>
			<div class="row">
				        <?php 
